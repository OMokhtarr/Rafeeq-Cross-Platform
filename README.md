...
| `src/shared/utils/VerseContextViewer.js` | `shared/components/verse-context/VerseContextViewer.tsx` | Proper component location |
| `src/shared/utils/snippetPositionMapper.js` | `shared/utils/snippetPositionMapper.ts` | TypeScript types added |
